...
export function createOptionsProvider(options: IORedisClusterOptions): Provider {
    return {
...
export function createOptionsAsyncProvider(options: ClusterModuleAsyncOptions): Provider {
    return {
        provide: CLUSTER_OPTIONS,
